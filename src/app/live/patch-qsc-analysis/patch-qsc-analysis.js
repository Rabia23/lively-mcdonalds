(function() {
  ...
  .directive('patchPieChart', function() {
      return {
        ...
        link: function(scope, ele, attrs) {
            var live_piechart = AmCharts.makeChart("piechart",
            {
                "type": "pie",
                "startDuration": 0,
                "angle": 25,
  ...
  .directive('patchBarOne', function() {
      return {
        ...
        link: function(scope, ele, attrs) {
            var live_patch_bar = AmCharts.makeChart("patch-bar",
            {
                "type": "serial",
  ...
  .directive('patchBarTwo', function() {
      return {
        ...
        link: function(scope, ele, attrs) {
              var live_patch_bar2   =  AmCharts.makeChart("patch-bar2",
              {
                  "type": "serial",
                  "categoryField": "category",
                  "startDuration": 1,
  ...
  .directive('patchChartDiv', function() {
      return {
        ...
        link: function(scope, ele, attrs) {
              var live_patch_chart=  AmCharts.makeChart("chartdiv",
              {
                  "type": "serial",
                  "categoryField": "category",
                  "columnWidth": 0.95,
